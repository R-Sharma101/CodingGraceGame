...
def purple_chamber_of_choices_room(player_info_arg):
    ...
    player_info_arg["location"] = "Purple Chamber of Choices"
    ...
    if treasure not in player_info_arg["inventory"]:
        ...
        print(f"A {treasure} has now shown up in your hand to add in your inventory")

    player_info_arg["choices"].append("Purple Chamber of Choices")
    show_player_info(player_info_arg)
    ...
    print("If you make the wrong choice the monster will get to you so be careful!")
    ...
    if "left" in choice:
        ...
        print("You chose the best option allowing you to leave!")
    elif "right" in choice:
        print("The monster had a friend here but this friend was nicer to you.")
        print("While you don't get the treasure you escape with your life.")
    elif "flee" in choice:
        return "flee"
    else:
        you_died("Due to your confusion the monster got to you and you have died")
